	...
	<%@ include file="/WEB-INF/jsp/common/js.jsp"%>
     ...
     /////////////////////////////////////////////////////       
            $("#leftToRightBtn").click(function(){
            	...
            	var selectList=$("#leftRoleList option:selected");
            	
            	if (selectList.length==0){
            		alert.msg("请选中",{icon:5,time:1000});
            		return false;
            	}
            	...
            	$.ajax({
            		   ...
            		   success:function(result){
		            		...
		            		if (result=="ok"){
				            	$("#rightRoleList").append(selectList.clone());
				            	selectList.remove();
         ...
         ////////////////////////////////////////////////////   
            $("#rightToLeftBtn").click(function(){
            	var selectList=$("#rightRoleList option:selected");
            	...
            	$.ajax({
            		   ...
            		   success:function(result){
		            		...
		            		if (result=="ok"){
				            	...
				            	$("#leftRoleList").append(selectList.clone());
				            	selectList.remove();
